...
//        super.viewDidLoad()
    ...
    private func setupUI() {
            ...
            button.addAction(UIAction{ [weak self] _ in
                ...
                print("Attempting to load Lynx View Controller from url")
                let url = "http://10.127.0.125:3000/main.lynx.bundle?fullscreen=true"
                ...
                self?.navigationController?.pushViewController(vc, animated: true) ?? print("Push failed: No nav controller")
